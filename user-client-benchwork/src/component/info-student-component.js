    ...
    <div className='container row'>
      ...
      <fieldset className="col-md-6 mb-6">
        ...
        <div className='container'>
          ...
          <p><b className="text-secondary">Invoice paid:</b> {(infoStudent[0].isbillpaid) ? "yes" : "no"} </p>
      ...
      <fieldset className="col-md-6 mb-6">
        ...
        <div className='container'>
          ...
          <p><b className="text-secondary">Completion date:</b> {infoStudent[0].dateendsession} </p>
